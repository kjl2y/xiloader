...
private:
     ...
     */
    static void print(color c, std::string const& message);
...
public:
    ...
    {
        output(color::white, format, args...);
    }
     ...
     */
    template<typename... Args>
    static void output(color c, char const* format, Args... args)
    {
        ...
        print(color::lightyelllow, timestamp);
